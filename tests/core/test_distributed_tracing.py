...
class TestDistributedTracing:
    ...
    async def test_setup_tracing(self, monkeypatch):
        ...
        with patch('resync.core.distributed_tracing.OTLPSpanExporter', lambda *args, **kwargs: mock_exporter):
            with patch('resync.core.distributed_tracing.TracerProvider', lambda: mock_tracer):
    ...
    async def test_traced_decorator(self):
        ...
        with patch('resync.core.distributed_tracing.trace.get_tracer_provider', lambda: mock_tracer):
