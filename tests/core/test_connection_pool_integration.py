...
class TestConnectionPoolIntegration:
    ...
    async def test_cross_pool_coordination(self, integrated_system):
        ...
        async def multi_pool_operation(operation_id: int):
            ...
            try:
                ...
                if http_pool:
                    async with http_pool.get_connection() as http_conn:
                        # Simulate API call
                        await asyncio.sleep(0.001)
    ...
    async def test_production_like_scenario(self, integrated_system):
        ...
        async def production_api_task(task_id: int):
            ...
            try:
                http_pool = pool_manager.get_pool("http")
                if http_pool:
                    async with http_pool.get_connection() as conn:
                        # Simulate API call
        ...
        print(f"Production scenario test:")
    ...
    async def test_error_recovery_and_resilience(self, integrated_system):
                ...
                if scenario_id == 0:
                    ...
                    if db_pool:
                        ...
                        async with db_pool.get_connection() as conn:
                            ...
                            try:
                                async with db_pool.get_connection(timeout=0.1) as conn2:
                                    pass
                            except Exception as e:
                ...
                # Scenario 2: Connection timeout
                    ...
                    if db_pool:
                        try:
                            ...
                            async with db_pool.get_connection(timeout=0.001) as conn:
        ...
        outcomes = await asyncio.gather(*scenario_tasks, return_exceptions=True)
        ...
        async def stress_operation(operation_id: int):
            ...
            try:
                ...
                for pool_name in ["database", "redis", "http"]:
                    ...
                    if pool:
                        try:
                            async with pool.get_connection(timeout=0.5) as conn:
