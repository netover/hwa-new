...
class TestInterfaceMethods:
    ...
    def test_ifile_ingestor_has_required_methods(self):
        ...
        interface_methods = [name for name in dir(IFileIngestor) if not name.startswith('_')]
...
class TestInterfaceImplementation:
    ...
    def test_interfaces_exist_and_are_protocols(self):
        ...
        interfaces = [IFileIngestor, IKnowledgeGraph, IAgentManager, IConnectionManager, IAuditQueue, ITWSClient]
