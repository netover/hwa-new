...
def test_business_logic_error_response_factories():
    ...
    not_found = BusinessLogicErrorResponse.resource_not_found("User", "user123", correlation_id="test-123")
...
def test_external_service_error_response_factories():
    ...
    service_unavailable = ExternalServiceErrorResponse.service_unavailable("TWS", correlation_id="test-123")
