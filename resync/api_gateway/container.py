...
from resync.api_gateway.services import ServiceFactory, ITWSService, IAgentService, IKnowledgeService
...
def setup_dependencies(tws_client: ITWSClient, agent_manager: IAgentManager, knowledge_graph: IKnowledgeGraph):
    ...
    container.register_singleton(
        ITWSService,
        ServiceFactory.create_tws_service(tws_client)
    )
    container.register_singleton(
        IAgentService,
