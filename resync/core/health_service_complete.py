...
>>>>>>> REPLACE
        ...
        logger.debug(f"Health check completed in {result.performance_metrics['total_check_time_ms']:.2f}ms")
    ...
    async def _check_database_health(self) -> ComponentHealth:
        ...
        try:
            ...
            if is_healthy:
                ...
                message = f"Database connection failed (errors: {stats.connection_errors})"
    ...
    async def _check_redis_health(self) -> ComponentHealth:
        ...
        try:
            ...
            if is_healthy:
                status = HealthStatus.HEALTHY
                message = f"Redis connection healthy (connected: {stats.active_connections})"
            else:
                status = HealthStatus.UNHEALTHY
    ...
    async def _check_file_system_health(self) -> ComponentHealth:
        ...
        try:
            ...
            critical_dirs = [
                ...
                settings.BASE_DIR / "temp" if hasattr(settings, 'TEMP_DIR') else Path("/tmp")
            ]
        ...
        try:
            ...
            return ComponentHealth(
                ...
                metadata={
                    ...
                    "swap_usage_percent": psutil.swap_memory().percent if hasattr(psutil, 'swap_memory') else 0
                }
            )
