...
from resync.core.connection_pool_manager import get_connection_pool_manager, shutdown_connection_pool_manager
...
async def lifespan(app: FastAPI):
    ...
    resource_manager.register_resource("knowledge_graph", knowledge_graph, lambda r: r.close())
