...
def sanitize_csp_report(report_data: Dict[str, Any]) -> Dict[str, Union[str, int, float, None]]:
    """
    ...
    string_fields = [
        'document-uri', 'violated-directive', 'original-policy',
        'blocked-uri', 'referrer', 'script-sample', 'source-file',
        'effective-directive'
    ]
