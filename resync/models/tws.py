...
class WorkstationStatus(BaseModel):
    ...
    status: str = Field(..., description="The current status of the workstation (e.g., 'LINKED', 'DOWN').")
...
class JobStatus(BaseModel):
    ...
    status: str = Field(..., description="The current status of the job (e.g., 'SUCC', 'ABEND').")
