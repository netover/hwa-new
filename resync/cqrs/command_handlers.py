...
from resync.cqrs.commands import (
    ...
    GetCriticalPathStatusCommand, GetJobStatusBatchCommand, UpdateJobStatusCommand,
...
class GetWorkstationsStatusCommandHandler(ICommandHandler[GetWorkstationsStatusCommand, CommandResult]):
...
class GetCriticalPathStatusCommandHandler(ICommandHandler[GetCriticalPathStatusCommand, CommandResult]):
