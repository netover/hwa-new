...
from .common import BaseValidatedModel, ValidationPatterns, NumericConstraints, StringConstraints
...
class PerformanceTestRequest(BaseValidatedModel):
    ...
    target_endpoint: constr(
        min_length=1,
        max_length=200,
        strip_whitespace=True
    ) = Field(
        ...,
        description="Target endpoint to test"
    )
