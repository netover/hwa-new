...
def with_monitoring(operation_name: str):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            start_time = runtime_metrics.time()
            ...
            try:
                ...
                runtime_metrics.record_counter(f"endpoint.{operation_name}.success", 1)
                runtime_metrics.record_histogram(
                    f"endpoint.{operation_name}.response_time",
                    runtime_metrics.time() - start_time
                )
                ...
                runtime_metrics.record_counter(f"endpoint.{operation_name}.error", 1)
