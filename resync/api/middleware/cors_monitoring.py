...
class CORSMonitor:
    ...
    def monitor_request(self, request: Request, operation: CORSOperation = CORSOperation.REQUEST) -> Dict[str, Any]:
        """
    ...
    def log_violation(self, origin: str, path: str, details: str = "", 
                     method: str = "", requested_headers: str = "") -> None:
        """
                ...
                if request.method == "OPTIONS":
                    ...
                    if origin:
                        ...
                        is_allowed = any(
                            ...
                            (allowed_origin.startswith(".") and origin.endswith(allowed_origin[1:]))
