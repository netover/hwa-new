...
try:
    ...
    exec(compile(open("resync/core/performance_optimizer.py").read(), 
                 "resync/core/performance_optimizer.py", 'exec'), 
...
try:
    ...
    # Execute with isolated namespace
    exec(compile(open("resync/core/resource_manager.py").read(),
                 "resync/core/resource_manager.py", 'exec'),
         res_module.__dict__)
