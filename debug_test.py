...
async def debug_integration_test():
    ...
    # Mock LLM call
    async def mock_call_llm(prompt, model, max_tokens=200, temperature=0.1, max_retries=3, initial_backoff=1.0):
    ...
    mock_knowledge_graph.get_relevant_context.return_value = "Previous context about job troubleshooting"
    ...
    mock_websocket.client = "test_client"</search>
</search_and_replace>
