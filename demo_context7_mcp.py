...
class Context7MCPDemo:
    ...
    def run_demo(self):
        ...
        try:
            ...
            self.test_resolve_library_id(process, library_name)
            ...
            docs_result = self.test_get_library_docs(
                process, library_id, topic="routing"
            )
                    ...
                    for item in content:
                        if isinstance(item, dict) and "text" in item:
                            ...
                            if "/react" in text.lower():
                                ...
                                docs_result2 = self.test_get_library_docs(
                                    library_id2, topic="hooks"
                                )
                                break
