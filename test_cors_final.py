...
def test_cors_development():
    ...
    from resync.api.middleware.cors_middleware import get_development_cors_config, add_cors_middleware
...
def test_cors_production():
    ...
    from resync.api.middleware.cors_middleware import get_production_cors_config, add_cors_middleware
...
def test_cors_test_environment():
    ...
    from resync.api.middleware.cors_middleware import get_test_cors_config, add_cors_middleware
...
def test_environment_policy_access():
    ...
    from resync.api.middleware.cors_config import cors_config, Environment
    ...
    assert dev_policy.allow_all_origins == True
    assert "*" in dev_policy.allowed_origins
    
    assert prod_policy.environment == Environment.PRODUCTION
    assert prod_policy.allow_all_origins == False
    assert prod_policy.allow_credentials == False
